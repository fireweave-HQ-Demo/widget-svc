# Fireweave tooling — stg_oodle_react_py
...
Clone/path: `/Users/kalyanchowdary/Desktop/code/work/test-bench/bench/workspaces/stg_oodle_react_py/tooling/marketplace`
Editor: open `stg_oodle_react_py.code-workspace` in Cursor (`bench open --name stg_oodle_react_py`)

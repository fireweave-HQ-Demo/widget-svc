# Fireweave tooling — sample_skills_git
...
Clone/path: `/workspaces/fireweaveai-platform/.worktrees/test-bench/bench/workspaces/sample_skills_git/tooling/marketplace`

...
Clone/path: `/Users/kalyanchowdary/Desktop/code/work/test-bench/bench/workspaces/stg_bench/tooling/marketplace`
Editor: open `stg_bench.code-workspace` in Cursor (`bench open --name stg_bench`)

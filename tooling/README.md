# Fireweave tooling — prod_oodle_bench
...
Clone/path: `/Users/kalyanchowdary/Desktop/code/work/test-bench/bench/workspaces/prod_oodle_bench/tooling/marketplace`
Editor: open `prod_oodle_bench.code-workspace` in Cursor (`bench open --name prod_oodle_bench`)

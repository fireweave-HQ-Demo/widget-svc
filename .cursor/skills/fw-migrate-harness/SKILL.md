...
reinstalled. Then re-run `mcp_rollout-server_detect_rollout_ready` and confirm
...
```
mcp_rollout-server_record_rollout_env_contract { cwd, apiSurface, webSurface, webappUrl? }
```
...
`mcp_rollout-server_update_repo_state`:
